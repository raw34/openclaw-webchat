...
import type { OpenClawClientOptions, Message, ConnectionState } from '@openclaw/chat-core';
import type { Ref, ComputedRef } from 'vue';

// Re-export core types
export type { OpenClawClientOptions, Message, ConnectionState } from '@openclaw/chat-core';
...
export interface UseOpenClawChatReturn {
  ...
  client: Ref<import('@openclaw/chat-core').OpenClawClient | null>;
}
